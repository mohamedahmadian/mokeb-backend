...
export declare class MawkibsService {
    ...
    findByOwner(ownerUserId: number): Promise<{
    ...
    getAvailableCapacity(mawkibId: number, reservationDate?: Date): Promise<number>;
    ...
    assertCapacity(mawkibId: number, guestCount: number, reservationDate: Date): Promise<void>;
}
